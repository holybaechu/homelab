...
- `hermes_newrrow_username_ref` and `hermes_newrrow_password_ref`, as 1Password secret references (for example `op://Homelab/Newrrow/username` and `op://Homelab/Newrrow/password`) read by the Hermes Newrrow skill at runtime
